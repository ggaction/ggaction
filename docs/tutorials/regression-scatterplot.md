...
![Acceleration by displacement with grouped regression](../assets/images/cars-regression-scatterplot.png){: loading="eager" fetchpriority="high" width="1520" height="960" }
...
[runnable browser example](https://github.com/ggaction/ggaction/tree/{{ site.data.provenance.exampleSourceRef }}/examples/cars-regression-scatterplot)
and its [complete program](https://github.com/ggaction/ggaction/blob/{{ site.data.provenance.exampleSourceRef }}/examples/cars-regression-scatterplot/program.js).
