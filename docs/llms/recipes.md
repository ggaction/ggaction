...
For structured retrieval, use the [complete machine-readable recipe metadata](../llms-recipes.json), which joins each
task intent to ordered action roles, executable examples, related recipes, and complete 173-action coverage.
