...
| Positioned text from x/y fields and row content | [`createTextPlot`](../reference/actions/charts-data.md#createtextplot) | H0 · user-facing · default | Refine the owned marks, encodings, or guides | [`createTextMark`](../reference/actions/marks.md#createtextmark) · [`encodeX`](../reference/actions/encodings.md#encodex) · [`encodeY`](../reference/actions/encodings.md#encodey) · [`encodeText`](../reference/actions/encodings.md#encodetext) · [`encodeColor`](../reference/actions/encodings.md#encodecolor) · [`createGuides`](../reference/actions/guides.md#createguides) |
