...
export function createCarsTemporalBarLinePrimitives(rows) {
  ...
  let program = chart()
    ...
    .editGraphics({ target: "bars", property: "strokeWidth", value: 1 })
    .createGraphics({ id: "trend", type: "path", parent: "plot-main" })
    ...
    .editGraphics({ target: "xAxisTicks", property: "stroke", value: AXIS_STROKE })
    ...
    .editGraphics({ target: "yAxisTicks", property: "stroke", value: AXIS_STROKE })
    ...
    .editGraphics({ target: "xAxisLabels", property: "rotation", value: 0 })
    ...
    .editGraphics({ target: "yAxisLabels", property: "rotation", value: 0 })
    ...
    .editGraphics({ target: "chartSubtitle", property: "rotation", value: 0 });
  return program;
}
