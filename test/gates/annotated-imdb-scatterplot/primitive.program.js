...
export function createAnnotatedImdbPrimitives(rows) {
  ...
  return chart()
    ...
    .createGraphics({ id: "labels", parent: "plot-main", type: "text", length: values.labels.length })
    .editGraphics({ target: "labels", property: "x", value: values.labels.map(label => label.x) })
    .editGraphics({ target: "labels", property: "y", value: values.labels.map(label => label.y) })
    .editGraphics({ target: "labels", property: "text", value: values.labels.map(label => label.text) })
    .editGraphics({ target: "labels", property: "fill", value: "#334155" })
    .editGraphics({ target: "labels", property: "fontSize", value: 10 })
    .editGraphics({ target: "labels", property: "fontFamily", value: "sans-serif" })
    .editGraphics({ target: "labels", property: "fontWeight", value: "normal" })
    .editGraphics({ target: "labels", property: "textAlign", value: "left" })
    .editGraphics({ target: "labels", property: "textBaseline", value: "bottom" })
    .editGraphics({ target: "labels", property: "rotation", value: 0 })
