...
import { createCarsHistogramEncodings } from "../programs/carsHistogramEncodings.js";

const carsPath = new URL("../../data/cars.json", import.meta.url);
const outputPath = new URL(
  "../output/cars-histogram-encodings.png",
  import.meta.url
);

test("writes the bar-mark-action cars histogram as a PNG", async () => {
