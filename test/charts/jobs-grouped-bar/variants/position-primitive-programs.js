...
export function createTemporalXPrimitives(rows) {
  ...
  return chart()
    ...
    .editSemantic({ property: "layer[bars].layout.mode", value: "group" })
    .editSemantic({ property: "layer[bars].encoding.group.field", value: "sex" })
    ...
    .editSemantic({ property: "scale[xOffset].paddingInner", value: 0 })
    .editSemantic({ property: "scale[xOffset].paddingOuter", value: 0 })
...
export function createHorizontalBarPrimitives(rows) {
  ...
  return chart()
    ...
    .editSemantic({ property: "layer[bars].encoding.color.fieldType", value: "nominal" })
    .editSemantic({ property: "layer[bars].encoding.color.scale", value: "color" })
    .editSemantic({ property: "layer[bars].layout.mode", value: "stack" })
    .editSemantic({ property: "layer[bars].encoding.group.field", value: "sex" })
    .editSemantic({ property: "layer[bars].encoding.group.fieldType", value: "nominal" })
    .editSemantic({ property: "layer[bars].encoding.group.inferredFrom", value: "color" })
