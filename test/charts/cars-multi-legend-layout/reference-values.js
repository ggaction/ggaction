...
export const LEGEND_LAYOUT = Object.freeze({
  ...
  top: Object.freeze({
    lineY: 19,
    chartGap: 14,
    colorSymbolX: Object.freeze([124.6112, 192.5712, 268.4512].map((x,i)=>x+0.25+i*0.5)),
    colorLabelX: Object.freeze([146.6112, 214.5712, 290.4512].map((x,i)=>x+0.5+i*0.5)),
    opacityTitleX: 365.97119999999995 + 1.5,
  ...
  bottom: Object.freeze({
    lineY: 596,
    chartGap: 20.5,
    colorSymbolX: Object.freeze([124.6112, 188.5712, 260.4512].map((x,i)=>x+0.25+i*0.5)),
    colorLabelX: Object.freeze([146.6112, 210.5712, 282.4512].map((x,i)=>x+0.5+i*0.5)),
    opacityTitleX: 357.97119999999995 + 1.5,
    opacitySymbolX: Object.freeze([
