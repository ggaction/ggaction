...
Label column, row/pitch/title spacing과 border가 같은 occupied slot을 사용한다. 기존 categorical grid 측정을 공유하며 interval, size와 stroke-width가 소비한다.
