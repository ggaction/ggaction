...
**현재 활성 계획은 Roadmap 7 Phase 7**이다. [상세 로드맵](impl/roadmap7/ROADMAP.md)은
사용자가 선택한 차트 저작 연산 25개를 다루며, [구현자 인계](impl/roadmap7/IMPLEMENTER_START_HERE.md)에서
읽기 순서와 작업 절차를 제공한다. Phase 1의 R06/R07은 `b891d1d5`, Phase 2의 R05/R08/R09는 `9d4d0840`, Phase 3의 R10은 `da0ca4e2`·`276c8318`·`32ddfcdd`, Phase 4의 R02는 `d29287c9`, Phase 5의 마지막 R19는 `58d9e51a`, Phase 6의 R27/R29는 `ded3b073`·`4aa9da65`에서 primary 구현됐고 나머지는 Phase별 원장이 상태를 소유한다.
