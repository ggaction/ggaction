...
**현재 활성 계획은 Roadmap 6 Phase 1**이다. 계층적 chart authoring과 action consistency의 상세 계획을
[`impl/roadmap6/ROADMAP.md`](impl/roadmap6/ROADMAP.md)에서 관리한다. 사용자 선택에 따라 새 액션군 F01–F19를
범위로 삼았다. 현재 재현 오류 교정을 시작했으며 후속 신규 API의 구체 설계는 Proposed다. 마지막 완료 owner는 Roadmap 5.4 Phase 6이다.
