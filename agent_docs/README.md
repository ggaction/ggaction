...
범위로 삼았다. Phase 2 [결과](impl/roadmap6/phase2/REVIEW.md)를 사용자 승인으로 닫고 Phase 3 [계약 package](impl/roadmap6/phase3/CONTRACT_REVIEW.md)는 ready-for-review다. Phase 3 API 구현은 아직 승인되지 않았다.
