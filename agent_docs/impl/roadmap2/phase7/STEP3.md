...
Approved Cars target를 vertical ranged-area actions와 statistical/explicit `createErrorBand`로 재현한다.
...
Canonical Cars public chain이 Gate A primitive와 exact match하고 vertical statistical/explicit contracts가 통과한다.
