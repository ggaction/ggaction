...
- [ ] Phase 12 — npm `0.0.1` initial public release와 repeatable publishing automation
...
완료된 public package를 npm에 `ggaction@0.0.1`로 배포한다. Package metadata와 license, minimal tarball,
...
- `ggaction@0.0.1`이 npm public registry에서 설치되고 세 public entry와 declaration이 registry consumer에서 통과한다.
