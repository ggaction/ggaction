...
> **문서 상태 — 현재 실행 계획.** R41-P7-A가 승인되어 Phase 7을 완료했고 Phase 8 facet columns, scale policy와
> guide policy editing을 진행한다.
...
| 8 | in-progress | Facet columns, scale policy와 guide policy editing |
