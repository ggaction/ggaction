...
> **문서 상태 — 현재 실행 계획.** Phase 0 contract Gate를 승인했고 Phase 1 구현은 완료되어 R41-P1-A 검토를
> 기다린다. 현재 observable behavior는
...
| 1 | in-progress | Encoding/radius teardown과 point/arc outline removal; R41-P1-A review pending |
