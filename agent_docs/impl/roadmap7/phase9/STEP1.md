...
| --- | --- | --- | --- | --- |
| Gate A 구현 고정 명세 | `f1a52284` | R47/R49 canonical feature spec, low-inference/work-package/state 계약 정합성, docs navigation/docs/diff 검증 | W1–W5 제품 코드와 Gate V/X 실행 증거 | ready-to-implement |
