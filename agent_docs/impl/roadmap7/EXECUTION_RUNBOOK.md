...
문서 상태: **실행 기준**. 기준일 2026-09-13. 사용자는 Roadmap 7의 25개 기능과 Phase 0–12 Gate를 모두 승인했다. 이 승인은 아래에 고정된 공개 계약과 구현 범위를 진행할 권한이며, 아직 구현되지 않은 기능을 Current로 표시해도 된다는 뜻은 아니다. Phase 0–10은 완료됐고 R43은 `89f1c54e`, `4dbdaf85`, `ebf3562a`에서 종료됐다. 현재는 Phase 11 R25를 끝낸 뒤 Phase 12 통합을 진행한다.
