...
문서 상태: **실행 기준**. 기준일 2026-09-13. 사용자는 Roadmap 7의 25개 기능과 Phase 0–12 Gate를 모두 승인했다. 이 승인은 아래에 고정된 공개 계약과 구현 범위를 진행할 권한이며, 아직 구현되지 않은 기능을 Current로 표시해도 된다는 뜻은 아니다. 현재 Phase 0–8 primary 경로가 구현됐고, R47은 `ce286929`, R49는 `0e09691a`–`31a2eee9`까지 제품 checkpoint가 있다. Phase 9의 남은 lifecycle·Current/docs/package closeout을 먼저 끝낸 뒤 Phase 10 R43, Phase 11 R25, Phase 12 통합을 진행한다.
