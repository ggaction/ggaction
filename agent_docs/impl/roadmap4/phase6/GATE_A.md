...
- 기본 width는 `{ band: 0.7 }`, palette는 `blues`, opacity range는 `[0, 1]`이다.
...
3. Cars primitive의 strip 폭, blues/opacity mapping, 1.5px median rule, right density legend와 목표 public chain
