...
- **현재 활성 계획은 Roadmap 6 Phase 2**이다. [`roadmap6/ROADMAP.md`](roadmap6/ROADMAP.md)는
  ...
  Phase 1 [결과](roadmap6/phase1/REVIEW.md)를 사용자 승인으로 닫고 Phase 2 계약 검토를 준비했다. 후속 신규 API의 구체 설계는 Proposed다.
- [`roadmap6/phase2/CONTRACT_REVIEW.md`](roadmap6/phase2/CONTRACT_REVIEW.md) — 현재 R6-P2-A API·호환성 검토, baseline 43건·기존 tests 100개
