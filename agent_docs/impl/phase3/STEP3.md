...
- [ ] Bar target을 지원하는 공용 `encodeX`
- [ ] `bin.maxBins` API와 validation
- [ ] Histogram bin/domain resolver
- [ ] `1, 2, 3, 5 × 10ⁿ` nice step
- [ ] Explicit domain 우선순위
- [ ] Cartesian coordinate와 semantic x scale
- [ ] Resolved binned x domain/range
- [ ] Incomplete bar collection materialization 유예
- [ ] Histogram progression의 raw x block 교체
- [ ] Unit, acceptance, PNG regression
- [ ] 영어 Encoding/scale/action/LLM 문서
