...
- [ ] `createThetaGrid` / `editThetaGrid`
- [ ] `createRadialGrid` / `editRadialGrid`
- [ ] Polar dispatch in `createGrid` / `editGrid`
- [ ] Explicit drawing order before marks
- [ ] Canvas and scale rematerialization
