# Roadmap 6 Phase 8 Gates — Statistical and endpoint charts
...
## R6-P8-A — Contract and scope

- 상태: planned
- 검토 대상: Interval/Regression layer·complete 구분, endpoint composite owner, ECDF denominator·step·weight.
