# Roadmap 6 Phase 10 Gates — Comparison and composition
...
## R6-P10-A — Contract and scope

- 상태: approved
- 검토 대상: Row/column facet, repeat, ordering, named-child edits, Polar/Parallel support와 per-cell policy.
