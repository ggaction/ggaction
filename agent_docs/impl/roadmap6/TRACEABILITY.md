...
- 처분: 진행 중. [W3 A](phase5/RESULTS_W3_TEXT_SOURCE.md)의 explicit source와 [W3 B1](phase5/RESULTS_W3_LABEL_CONTENT.md)의 category/value/share·percent·source replay를 구현·검증했다. [W3 B2](phase5/RESULTS_W3_MARK_LABELS.md)의 createMarkLabels facade도 구현·검증했다. reference/annotation 및 공통 formatter/rotation은 남아 있다. 전체 승인 하에 계속 구현한다.
