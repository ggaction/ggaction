...
- 처분: 진행 중. [W3 A](phase5/RESULTS_W3_TEXT_SOURCE.md)의 explicit source와 [W3 B1](phase5/RESULTS_W3_LABEL_CONTENT.md)의 category/value/share·percent·source replay를 구현·검증했다. [W3 B2](phase5/RESULTS_W3_MARK_LABELS.md)의 createMarkLabels facade도 구현·검증했다. [W3 C1](phase5/RESULTS_W3_REFERENCE_RECT.md)의 Rect datum/span 기반과 temporal selection #113도 해결했다. [W3 C2](phase5/RESULTS_W3_REFERENCES.md)의 createReferenceLine/createReferenceBand도 구현·검증했다. Annotation 선행 [Text scale ownership #115](phase5/RESULTS_W3_TEXT_SCALE_OWNERSHIP.md)과 [independent Text datum position](phase5/RESULTS_W3_TEXT_DATUM.md)을 완성하고 [createAnnotation](phase5/RESULTS_W3_ANNOTATION.md)의 mark/data/plot anchor를 구현·검증했다. 공통 formatter/rotation은 남아 있다. 전체 승인 하에 계속 구현한다.
