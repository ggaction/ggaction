...
| user-facing | [`createBinData`](current/CORE.md#createbindata) | statistics | Mutable resource | Complete | ✅ / ✅ / ✅ |
...
| user-facing | [`createDensityData`](current/CORE.md#createdensitydata) | core | Mutable resource | Intentional | ✅ / ✅ / ✅ |
| user-facing | [`createRegressionData`](current/CORE.md#createregressiondata) | core | Mutable resource | Intentional | ✅ / ✅ / ✅ |
| user-facing | [`createWindowData`](current/CORE.md#createwindowdata) | core | Mutable resource | Intentional | ✅ / ✅ / ✅ |
| user-facing | [`createTimeUnitData`](current/CORE.md#createtimeunitdata) | core | Mutable resource | Intentional | ✅ / ✅ / ✅ |
...
| user-facing | [`editDerivedData`](current/CORE.md#editderiveddata) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editComputedData`](current/CORE.md#editcomputeddata) | statistics | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editFilteredData`](current/CORE.md#editfiltereddata) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editFoldData`](current/CORE.md#editfolddata) | statistics | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editSummaryData`](current/CORE.md#editsummarydata) | statistics | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editBinData`](current/CORE.md#editbindata) | statistics | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editTimeUnitData`](current/CORE.md#edittimeunitdata) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editWindowData`](current/CORE.md#editwindowdata) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editDensityData`](current/CORE.md#editdensitydata) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editStackData`](current/CORE.md#editstackdata) | statistics | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editRegressionData`](current/CORE.md#editregressiondata) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
...
| user-facing | [`createECDFData`](current/STATISTICS.md#createecdfdata) | statistics | Mutable resource | Intentional | ✅ / ✅ / ✅ |
...
| user-facing | [`editMarkLabelSelection`](current/MARKS.md#editmarklabelselection) | marks | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editMarkLabelPlacement`](current/MARKS.md#editmarklabelplacement) | marks | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`removeMarkLabels`](current/MARKS.md#removemarklabels) | marks | Mutable resource | Complete | ✅ / ✅ / ✅ |
...
| advanced | [`encodeChannels`](current/ENCODINGS.md#encodechannels) | encodings | Assignment | Final-state reassignment — Implemented | ✅ / ✅ / ✅ |
...
| user-facing | [`editLegendBlock`](current/LEGEND_AND_TITLE.md#editlegendblock) | legend_and_title | Mutable resource | Complete | ✅ / ✅ / ✅ |
...
| user-facing | [`editCoordinate`](current/CORE.md#editcoordinate) | core | Mutable resource | Coordinate aspect and Polar frame — Implemented | ✅ / ✅ / ✅ |
...
| user-facing | [`editXOffsetScale`](current/CORE.md#editxoffsetscale) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editYOffsetScale`](current/CORE.md#edityoffsetscale) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
| user-facing | [`editParallelScale`](current/CORE.md#editparallelscale) | core | Mutable resource | Complete | ✅ / ✅ / ✅ |
...
| user-facing | [`createTextPlot`](current/BASIC_CHARTS.md#createtextplot) | charts | Aggregate create-only | Intentional | ✅ / ✅ / ✅ |
