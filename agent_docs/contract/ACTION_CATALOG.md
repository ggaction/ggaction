...
| user-facing | [`createBoxPlot`](current/COMPOSITE_MARKS.md#createboxplot) | statistics | Aggregate create-only | Intentional vertical Tukey scope; horizontal and option expansion remain planned | ✅ / ✅ / ✅ |
