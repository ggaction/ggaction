...
const evaluatorSourcePaths = [
  ...
  "scripts/compact-paid-comparison-v9.js",
  "scripts/run-compact-paid-comparison-v9.js",
...
if (dirty !== "") {
  throw new Error("Commit the complete v9 evaluator before freezing its plan.");
}
...
const plan = {
  schemaVersion: 1,
  id: "compact-authoring-paid-comparison-v9",
  requiredGate: "R54-P6-A",
...
await writeFile(
  `${paidComparisonRootV9}/PLAN.json`,
